 ...
 * We have modified the search indexing of the multiselect to speed up the performance
 * of the search in the bootstrap multiselect dropdowns. REF - http://pys.me/TVF [RS] [7/21/2015]
 */
!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                ...
                filter: '<li class="multiselect-item filter"><div class="input-group"><span class="input-group-addon"><i class="glyphicons glyphicons-search"></i></span><input class="form-control multiselect-search" type="text"></div></li>',
                filterClearBtn: '<span class="input-group-btn"><button class="btn btn-default multiselect-clear-filter" type="button"><i class="glyphicons glyphicons-remove-circle"></i></button></span>',
