    ...
    def duplicate
      ...
      respond_to do |format|
        if survey_template_copy.save!
          survey_template_copy.remap_conditional_logic(@survey_template)
          format.html { redirect_to hanuman_admin_path + "/survey_templates/" + survey_template.id.to_s + "/edit", notice: 'Survey template was successfully duplicated, please rename.' }
