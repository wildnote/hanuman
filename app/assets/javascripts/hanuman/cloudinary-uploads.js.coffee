...
addTexareaForUpload = (file, data, idx) ->
  ...
  $("."+file+"-preview").append "<br>"
  $("."+file+"-preview").append "<textarea rows=2 cols=55 style='margin:20px 0 20px 0;' placeholder='Add "+file+" description here...' name="+nameAttr+"></textarea>"
  $("."+file+"-preview").append "<input class='"+file+"-hidden-input' value="+fileValue+" type='hidden'  name="+hiddenNameAttr+">"
  $("."+file+"-preview").append "<br>"
