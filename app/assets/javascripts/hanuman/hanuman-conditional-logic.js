...
this.ConditionalLogic = (function() {
  ...
  class ConditionalLogic {
      ...
      $context.find("[data-rule!=''][data-rule]").each(function() {
        ...
        return $(rules).each(function() {
          ...
          $(rule.conditions).each(function() {
            ...
            if (rule.type !== "Hanuman::CalculationRule") {
              if (runConditionals) {
                return self.checkConditionsAndHideShow(rule.conditions, ancestorId, $ruleContainer, $ruleContainer, inRepeater, matchType, rule, true);
              }
            }
          });
            ...
            return $(rules).each(function() {
              ...
              if (matchingCondition.length > 0) {
                if (conditions.length > 1) {
                  return self.checkConditionsAndHideShow(conditions, ancestorId, $ruleElement, $container, inRepeater, matchType, this, false);
                } else {
    ...
    hideShowQuestions(hide_questions, ancestor_id, $ruleElement, $container, inRepeater) {
      ...
      // deal with container
      if (hide_questions) {
        return $container.addClass("conditional-logic-hidden");
      } else {
        ...
        return $childrenContainers.each(function() {
          if ($(this).attr("data-rule") === "") {
            return $(this).removeClass("conditional-logic-hidden");
          }
        });
      }
    }
...
$(function() {
  ...
  if ($('input#run_cl').length) {
    ...
    return cl.findRules(false, true, $context);
  }
});
