...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'actionmailer',     '~> 8.1.2'
  s.add_dependency 'actionpack',       '~> 8.1.2'
  s.add_dependency 'activemodel',      '~> 8.1.2'
  s.add_dependency 'activerecord',     '~> 8.1.2'
  s.add_dependency 'activesupport',    '~> 8.1.2'
  s.add_dependency 'railties',         '~> 8.1.2'
  s.add_dependency 'actionview',       '~> 8.1.2'
  s.add_dependency 'activejob',        '~> 8.1.2'
